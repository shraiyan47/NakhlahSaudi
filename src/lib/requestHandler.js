...
export const getMap = {
  ...
  "content-details" : `${BASE_URL}/api/content-details?pagination[page]=1&pagination[pageSize]=999999&populate=*`,
...
export const getQuestionUrl = (id) => {
  ...
  return `api/questions?pagination[page]=1&pagination[pageSize]=999999&populate=*`;
}
