...
const setContentData = useContent( (state) => state.setContents  );
  ...
  const [contentDetailsTitle, setContentDetailsTitle] = useState(useForEdit ? rowData.contentDetailsTitle : "");
  const [contentDetailsAudio, setContentDetailsAudio] = useState(useForEdit ? rowData.contentDetailsAudio : "");
